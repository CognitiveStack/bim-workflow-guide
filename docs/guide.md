# The Autodesk BIM Coordination Workflow — Complete Guide

A single-page guide to the modern, cloud-first BIM coordination workflow, built around a Revit-generated teaching diagram. Read it top to bottom, or jump to a section.
...
**Reference pages (separate):** [Glossary](glossary.md) · [Build runbook](08-revit-3d-workflow-diagram-plan.md) · [Build prompt](08-revit-build-prompt.md) · [Versioning & exports](versioning-and-exports.md) · [Diagram exports & credit](../diagrams/revit/README.md) · [Inspiration & credit](../diagrams/inspiration/README.md)
...
I'll be honest: my Revit skills aren't advanced enough to model this by hand. What made it possible was the **pyRevit MCP server** — [github.com/CognitiveStack/revit-mcp-server](https://github.com/CognitiveStack/revit-mcp-server) — which let me drive Revit programmatically and build the 3D diagram through an AI-assisted workflow instead of manual modelling. The build is documented in the [Revit 3D diagram build runbook](08-revit-3d-workflow-diagram-plan.md) and the [Desktop build prompt](08-revit-build-prompt.md).
...
*New to a term? See the [Glossary](glossary.md). Want to build the diagram yourself? See the [build runbook](08-revit-3d-workflow-diagram-plan.md).*
